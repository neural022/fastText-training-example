...
void Args::parseArgs(const std::vector<std::string>& args) {
  ...
  for (int ai = 2; ai < args.size(); ai += 2) {
    ...
    try 
	{
	  ...
	  else if (args[ai] == "-input") input = std::string(args.at(ai + 1));
      else if (args[ai] == "-output") output = std::string(args.at(ai + 1));
      else if (args[ai] == "-lr") lr = std::stof(args.at(ai + 1));
      else if (args[ai] == "-lrUpdateRate") lrUpdateRate = std::stoi(args.at(ai + 1));
      else if (args[ai] == "-dim") dim = std::stoi(args.at(ai + 1));
      else if (args[ai] == "-ws") ws = std::stoi(args.at(ai + 1));
      else if (args[ai] == "-epoch") epoch = std::stoi(args.at(ai + 1));
      else if (args[ai] == "-minCount") minCount = std::stoi(args.at(ai + 1));
      else if (args[ai] == "-minCountLabel") minCountLabel = std::stoi(args.at(ai + 1));
      else if (args[ai] == "-neg") neg = std::stoi(args.at(ai + 1));
      else if (args[ai] == "-wordNgrams") wordNgrams = std::stoi(args.at(ai + 1));
      else if (args[ai] == "-loss") 
	  {
		  if (args.at(ai + 1) == "hs") loss = loss_name::hs;
		  else if (args.at(ai + 1) == "ns") loss = loss_name::ns;
          else if (args.at(ai + 1) == "softmax") loss = loss_name::softmax;
          else 
		  {
	  ...
	  else if (args[ai] == "-bucket") bucket = std::stoi(args.at(ai + 1));
      else if (args[ai] == "-minn") minn = std::stoi(args.at(ai + 1));
      else if (args[ai] == "-maxn") maxn = std::stoi(args.at(ai + 1));
	  else if (args[ai] == "-thread") thread = std::stoi(args.at(ai + 1));
      else if (args[ai] == "-t") t = std::stof(args.at(ai + 1));
      else if (args[ai] == "-label") label = std::string(args.at(ai + 1));
      else if (args[ai] == "-verbose") verbose = std::stoi(args.at(ai + 1));
      else if (args[ai] == "-pretrainedVectors") pretrainedVectors = std::string(args.at(ai + 1));
	  ...
	  else if (args[ai] == "-cutoff") cutoff = std::stoi(args.at(ai + 1));
      else if (args[ai] == "-dsub") dsub = std::stoi(args.at(ai + 1));
      else 
	  {
  ...
  if (wordNgrams <= 1 && maxn == 0) bucket = 0;
}
